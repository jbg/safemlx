use half::{bf16, f16};
use safemlx_internal_macros::generate_test_cases;
use strum::EnumIter;
...
generate_test_cases! {
    ...
    pub enum Dtype {
        /// bool
        Bool = safemlx_sys::mlx_dtype__MLX_BOOL,

        /// u8
        Uint8 = safemlx_sys::mlx_dtype__MLX_UINT8,

        /// u16
        Uint16 = safemlx_sys::mlx_dtype__MLX_UINT16,

        /// u32
        Uint32 = safemlx_sys::mlx_dtype__MLX_UINT32,

        /// u64
        Uint64 = safemlx_sys::mlx_dtype__MLX_UINT64,

        /// i8
        Int8 = safemlx_sys::mlx_dtype__MLX_INT8,

        /// i16
        Int16 = safemlx_sys::mlx_dtype__MLX_INT16,

        /// i32
        Int32 = safemlx_sys::mlx_dtype__MLX_INT32,

        /// i64
        Int64 = safemlx_sys::mlx_dtype__MLX_INT64,

        /// f16
        Float16 = safemlx_sys::mlx_dtype__MLX_FLOAT16,

        /// f32
        Float32 = safemlx_sys::mlx_dtype__MLX_FLOAT32,

        /// f64
        Float64 = safemlx_sys::mlx_dtype__MLX_FLOAT64,

        /// bfloat16
        Bfloat16 = safemlx_sys::mlx_dtype__MLX_BFLOAT16,

        /// complex64
        Complex64 = safemlx_sys::mlx_dtype__MLX_COMPLEX64,
    }
}
