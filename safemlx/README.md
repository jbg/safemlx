...
[![Documentation](https://img.shields.io/badge/docs-latest-blue)](https://github.com/jbg/safemlx)
...
Due to known limitation of docsrs, upstream hosts generated documentation on
GitHub Pages. This fork will use SafeMLX documentation once published.
